 ...
 * @author Joshua Godi
 */
public class JumbotronPresenter extends Presenter<JumbotronPresenter.MyView, JumbotronPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.JUMBOTRON)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<JumbotronPresenter> {
    }
