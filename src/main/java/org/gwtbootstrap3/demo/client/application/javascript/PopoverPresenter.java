 ...
 * @author Joshua Godi
 */
public class PopoverPresenter extends Presenter<PopoverPresenter.MyView, PopoverPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.POPOVER)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<PopoverPresenter> {
    }
