 ...
 * @author Joshua Godi
 */
public class WellPresenter extends Presenter<WellPresenter.MyView, WellPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.WELLS)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<WellPresenter> {
    }
