 ...
 * @author Joshua Godi
 */
public class ThumbnailPresenter extends Presenter<ThumbnailPresenter.MyView, ThumbnailPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.THUMBNAILS)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<ThumbnailPresenter> {
    }
