 ...
 * @author Joshua Godi
 */
public class MediaObjectPresenter extends Presenter<MediaObjectPresenter.MyView, MediaObjectPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.MEDIA_OBJECTS)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<MediaObjectPresenter> {
    }
