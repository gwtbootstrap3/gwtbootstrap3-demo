 ...
 */
public class GrowlPresenter extends Presenter<GrowlPresenter.MyView, GrowlPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.GROWL)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<GrowlPresenter> {
    }
