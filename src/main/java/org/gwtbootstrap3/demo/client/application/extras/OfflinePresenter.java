 ...
 * @author Joshua Godi
 */
public class OfflinePresenter extends Presenter<OfflinePresenter.MyView, OfflinePresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.OFFLINE)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<OfflinePresenter> {
    }
