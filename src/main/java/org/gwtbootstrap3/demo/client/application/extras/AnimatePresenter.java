 ...
 * @author Joshua Godi
 */
public class AnimatePresenter extends Presenter<AnimatePresenter.MyView, AnimatePresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.ANIMATE)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<AnimatePresenter> {
    }
