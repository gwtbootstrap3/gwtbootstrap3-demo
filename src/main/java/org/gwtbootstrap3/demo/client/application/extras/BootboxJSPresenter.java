 ...
 * @author Joshua Godi
 */
public class BootboxJSPresenter extends Presenter<BootboxJSPresenter.MyView, BootboxJSPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.BOOTBOX)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<BootboxJSPresenter> {
    }
