 ...
 * @author Joshua Godi
 */
public class ToggleSwitchPresenter extends Presenter<ToggleSwitchPresenter.MyView, ToggleSwitchPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.TOGGLESWITCH)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<ToggleSwitchPresenter> {
    }
