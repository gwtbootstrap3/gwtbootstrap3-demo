 ...
 */
public class TagsInputPresenter extends Presenter<TagsInputPresenter.MyView, TagsInputPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.TAGSINPUT)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<TagsInputPresenter> {
    }
