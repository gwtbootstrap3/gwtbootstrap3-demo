 ...
 * @author Joshua Godi
 */
public class ProgressBarPresenter extends Presenter<ProgressBarPresenter.MyView, ProgressBarPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.PROGRESS_BARS)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<ProgressBarPresenter> {
    }
