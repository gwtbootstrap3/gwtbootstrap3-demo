 ...
 * @author Joshua Godi
 */
public class SliderPresenter extends Presenter<SliderPresenter.MyView, SliderPresenter.MyProxy> {
    ...
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<SliderPresenter> {
    }
