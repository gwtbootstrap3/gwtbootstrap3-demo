 ...
 * @author Joshua Godi
 */
public class LabelPresenter extends Presenter<LabelPresenter.MyView, LabelPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.LABELS)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<LabelPresenter> {
    }
