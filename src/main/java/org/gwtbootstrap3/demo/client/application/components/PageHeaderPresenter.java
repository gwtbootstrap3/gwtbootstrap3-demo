 ...
 * @author Joshua Godi
 */
public class PageHeaderPresenter extends Presenter<PageHeaderPresenter.MyView, PageHeaderPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.PAGE_HEADER)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<PageHeaderPresenter> {
    }
