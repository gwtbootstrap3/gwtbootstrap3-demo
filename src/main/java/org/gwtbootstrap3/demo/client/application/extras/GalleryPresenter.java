 ...
 * @author Ben Dol
 */
public class GalleryPresenter extends Presenter<GalleryPresenter.MyView, GalleryPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.GALLERY)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<GalleryPresenter> {
    }
