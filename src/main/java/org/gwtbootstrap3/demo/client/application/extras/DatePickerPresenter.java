 ...
 * @author Joshua Godi
 */
public class DatePickerPresenter extends Presenter<DatePickerPresenter.MyView, DatePickerPresenter.MyProxy> {

    public interface MyView extends View {
    }

    @NameToken(NameTokens.DATE_PICKER)
    @ProxyCodeSplit
    public interface MyProxy extends ProxyPlace<DatePickerPresenter> {
    }
